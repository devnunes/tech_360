    ...
    <div className="p-3 rounded-lg flex flex-col gap-3 shadow-shape-content bg-white-/2 relative overflow-hidden">
      <div className="flex flex-col gap-1">
        ...
        <span className="text-xxs text-zinc-400 flex gap-1.5 items-center">
          <span className="line-through">2.3 MB</span>
      ...
      <div className="absolute top-2.5 right-2.5 flex items-center gap-1">
        <Button size="icon-sm">
          <Download size={4} strokeWidth={1.5} />
          <span className="sr-only">Download compressed image</span>
        </Button>

        <Button size="icon-sm">
          <Link2 size={4} strokeWidth={1.5} />
          <span className="sr-only">Copy remote URL</span>
        </Button>

        <Button size="icon-sm">
          <RefreshCcw size={4} strokeWidth={1.5} />
          <span className="sr-only">Retry upload</span>
        </Button>

        <Button size="icon-sm">
          <X size={4} strokeWidth={1.5} />
